...
@section("container")
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 my-4">
        ...
        <div class="row g-5 mt-lg-3">
            ...
            <form method="post" action="/student" class="needs-validation d-flex" novalidate>
                    ...
                    <div class="col-md-10 col-lg-0">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input autofocus type="text" class="form-control @error('nis') is-invalid @enderror"
                            ...
                            <div class="col-sm-6">
                                ...
                                <select  class="form-control @error('extra_id') is-invalid @enderror"
                                    ...
                                    @foreach ($extra as $ext)
                                        <option value="{{ $ext->id }}" {{ old('extra_id') == $ext->id ? 'selected' : '' }}>{{ $ext->nama }}</option>
                                    @endforeach
